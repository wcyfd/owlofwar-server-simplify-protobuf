...
public final class Game {
  ...
  public static final class GameAction extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.internal_static_com_randioo_owlofwar_server_simplify_protobuf_protocol_GameAction_descriptor;
    }
    ...
    public static com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction parseFrom(
    ...
    public static com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction parseFrom(
    ...
    public static com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction prototype) {
    ...
    public static final class Builder extends
      ...
      private com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction result;
      
      // Construct using com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction();
        return builder;
      }
      
      protected com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction();
        return this;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction.getDescriptor();
      }
      
      public com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction getDefaultInstanceForType() {
        return com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction build() {
      ...
      private com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
      ...
      public com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction) {
          return mergeFrom((com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.GameAction)other);
        } else {
      ...
      // @@protoc_insertion_point(builder_scope:com.randioo.owlofwar_server_simplify_protobuf.protocol.GameAction)
    }
    
    static {
      defaultInstance = new GameAction(true);
      com.randioo.owlofwar_server_simplify_protobuf.protocol.Game.internalForceInit();
      defaultInstance.initFields();
    }
    
    // @@protoc_insertion_point(class_scope:com.randioo.owlofwar_server_simplify_protobuf.protocol.GameAction)
  }
  ...
  private static
    com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internal_static_com_randioo_owlofwar_server_simplify_protobuf_protocol_GameAction_fieldAccessorTable;
